...
<c:url value="../static/Scripts/jquery-1.9.1.min.js" var="jquery" />
<c:url value="../static/Scripts/jquery-ui-1.10.3.min.js" var="jquery2" />
<c:url value="../static/Scripts/knockout-3.2.0.js" var="knockout" />
<c:url value="../static/Scripts/turn.min.js" var="turn" />
<c:url value="../static/Scripts/modernizr.2.6.2.Transform2d.min.js"
	var="transform2d" />
<c:url value="../static/Scripts/installableViewer.js"
	var="installableViewer" />
<c:url value="../static/Scripts/GroupdocsViewer.all.js"
	var="GroupDocsViewer" />
<c:url value="../static/Content/CSS/bootstrap.css" var="bootstrapCss" />
<c:url value="../static/Content/CSS/groupdocsViewer.all.css"
	var="GroupDocsViewerCss" />
<c:url value="../static/Content/CSS/dialog.css" var="dialogCss" />
